...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/valuation/manageValuation/">区域经理定价列表</a></li>
		<li class="active"><a href="${ctx}/valuation/manageValuation/form?id=${manageValuation.id}">区域经理定价<shiro:hasPermission name="valuation:manageValuation:edit">${not empty manageValuation.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="valuation:manageValuation:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="manageValuation" action="${ctx}/valuation/manageValuation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="div-b">
				<label class="control-label">设置客户一类价格关联：</label>
				<div class="controls">
		...
		<div class="control-group">
			...
			<div class="div-b">
				<label class="control-label">设置客户二类价格关联：</label>
				<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="valuation:manageValuation:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
