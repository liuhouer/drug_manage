...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/repo/acceptance/">验收单列表</a></li>
		<li class="active"><a href="${ctx}/repo/acceptance/form?id=${acceptance.id}">验收单<shiro:hasPermission name="repo:acceptance:edit">${not empty acceptance.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="repo:acceptance:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
