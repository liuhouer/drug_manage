...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/repo/acceptance/">破损/报废单列表</a></li>
		<shiro:hasPermission name="repo:acceptance:edit"><li><a href="${ctx}/repo/acceptance/form">破损/报废单添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="acceptance">
			<tr>
				...
				<shiro:hasPermission name="repo:acceptance:edit"><td>
					...
					<a href="${ctx}/repo/acceptance/delete?id=${acceptance.id}" onclick="return confirmx('确认要删除该破损/报废单吗？', this.href)">删除</a>
