...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/repo/receipt/">收货单列表</a></li>
		<li class="active"><a href="${ctx}/repo/receipt/form?id=${receipt.id}">收货单<shiro:hasPermission name="repo:receipt:edit">${not empty receipt.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="repo:receipt:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="receipt" action="${ctx}/repo/receipt/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<div class="div-a">
				<label class="control-label">采购信息：</label>
				<div class="controls">
		...
		<div class="control-group">
			<div class="div-a">
				...
				<div class="controls">
					<form:input path="abstractData" htmlEscape="false" maxlength="500" class="input-xlarge "/>
				</div>
			</div>
			<div class="div-b">
		...
		<div class="form-actions">
			<shiro:hasPermission name="repo:receipt:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
